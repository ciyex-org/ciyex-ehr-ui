...
export default function UserDropdown() {
        ...
        if (storedUser) {
            try {
                ...
                setUser({
                    ...
                    email: parsed.email,
                    profileImage: parsed.profileImage, // ✅ No fallback
                });
            } catch (err) {
    ...
    return (
        <div className="relative">
            ...
            >
    <span className="mr-3 rounded-full h-11 w-11 bg-blue-600 text-white flex items-center justify-center font-semibold text-sm">
