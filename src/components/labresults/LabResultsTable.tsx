                ...
                <tr key={r.id} className="border-t dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-1 justify-end">
                      <button onClick={() => openEdit(r)} title="Edit" className="p-1.5 rounded hover:bg-blue-50 dark:hover:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs">Edit</button>
                      <button onClick={() => del(r.id)} title="Delete" className="p-1.5 rounded hover:bg-red-50 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 text-xs">Del</button>
                    </div>
                  </td>
                </tr>
              ))}
                      ...
                      {items.map(r => (
                        <tr key={r.id} className="border-t dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                          ...
                          <td className="px-4 py-2 text-right">
                            <button onClick={() => openEdit(r)} className="text-xs text-blue-600 dark:text-blue-400 hover:underline mr-2">Edit</button>
                            {!r.signed && <button onClick={() => sign(r)} className="text-xs text-green-600 dark:text-green-400 hover:underline">Sign</button>}
                          </td>
                        </tr>
                      ))}
                    </tbody>
