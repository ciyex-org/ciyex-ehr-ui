        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-800/80 text-left">
              ...
              <th className="px-4 py-2.5 font-medium text-slate-500 dark:text-slate-400 text-right">Prompt Tokens</th>
              <th className="px-4 py-2.5 font-medium text-slate-500 dark:text-slate-400 text-right">Completion Tokens</th>
              <th className="px-4 py-2.5 font-medium text-slate-500 dark:text-slate-400 text-right">Total Tokens</th>
