...
const ToastNotificationComponent: React.FC<{
    ...
    return (
        <div
            className={`${getToastStyles()} text-white px-6 py-4 rounded-lg shadow-lg border-l-4 flex items-center justify-between min-w-96 max-w-lg transform transition-all duration-300 ${
